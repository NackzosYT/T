...
client.on('message', message => {
    if (message.content === 'inv') {
        let helpEmbed = new Discord.RichEmbed()
        .setTitle('**أضغط على الرابط لدعوة البوت**') 
        .setDescription('https://discordapp.com/oauth2/authorize?client_id=511205433919275029&permissions=268435616&scope=bot')
             .addField('SnowBot')
      message.channel.send(helpEmbed);
    }
});
...
client.user.setGame(`*play | Last Music`,"http://twitch.tv/nackzosyt")
