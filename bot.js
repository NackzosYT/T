...
welcomer.sendFile(canvas.toBuffer())
    ...
    let channel = member.guild.channels.get('504657814971744259');
    if (!channel) {
    ...
    var guild;
    while (!guild)
        guild = client.guilds.get("502216103410401311")
channel.send(`**#Welcome To  Server Blood Server..:blue_heart:**`)   
